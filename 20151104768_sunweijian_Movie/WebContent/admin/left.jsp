...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('0104','01','商品管理');
		d.add('010401','0104','已上架电影列表','${pageContext.request.contextPath}/adminProduct?method=findAll','','mainFrame');
		d.add('010402','0104','添加电影','${pageContext.request.contextPath}/adminProduct?method=addUI','','mainFrame');
		d.add('0105','01','订单管理');
