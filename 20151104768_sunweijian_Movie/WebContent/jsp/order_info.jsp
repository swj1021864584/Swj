			...
			<div>
				...
				<form action="${pageContext.request.contextPath }/order" id="orderForm" method="post" class="form-horizontal" style="margin-top:5px;margin-left:150px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="address" class="form-control" id="username" placeholder="请输入取票人地址">
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-sm-1 control-label">取票人</label>
						<div class="col-sm-5">
							<input type="text" name="name" class="form-control" id="inputPassword3" placeholder="请输取票人">
						</div>
					</div>
					<div class="form-group">
				...
				<div style="margin-top:5px;margin-left:150px;">
					...
					<p>
						<br/>
						<input type="radio" name="pd_FrpId" value="ICBC-NET" checked="checked" />工商银行
